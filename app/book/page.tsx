...
export default function BookPage() {
  ...
  // NEW PRICE SYSTEM
  // Base yard price + upgrades
  // Packages override individual service pricing
  ...
  function calculatePrice() {
    ...
    // Extra services only if not using package
    if (!selectedPackage) {
    ...
    saveBooking().then((saved)=>{
      ...
      emailjs
        ...
        .catch((error)=>{
          ...
          alert(
            "Booking saved! Email failed to send."
          );
        ...
        >
         ...
         {selectedDate && (
          ...
          <div>
            ...
            <div className="grid md:grid-2 gap-3 mt-3">
